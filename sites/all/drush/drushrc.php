 ...
 */
$options['structure-tables']['common'] = array('cache', 'cache_admin_menu', 'cache_block', 'cache_bootstrap', 'cache_ds_panels', 'cache_field', 'cache_filter', 'cache_form', 'cache_image', 'cache_location', 'cache_menu', 'cache_page', 'cache_path', 'cache_rules', 'cache_token', 'cache_update', 'cache_views', 'cache_views_data', 'history', 'search_dataset', 'search_index', 'search_node_links', 'search_total', 'sessions', 'watchdog');
